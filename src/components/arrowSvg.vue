<template>
  <svg
    ...
    width="323.000000pt"
    height="178.000000pt"
    viewBox="0 0 323.000000 178.000000"
  ...
  >
    ...
    <g
      ...
      stroke="#000000"
    >
      <path class="draw" :stroke-dasharray="`${pathLength} ${pathLength}`" str
        d="M1920 1539 c-30 -5 -88 -25 -128 -46 -163 -81 -268 -264 -296 -515
...
export default {
    ...
    mounted() {
        this.pathLength = document.querySelector(".draw").totalLength()
